...
LIBRARY_TESTS="channel data_segment date_time error event keyword level manifest map notify opcode provider support task template xml_document xml_tag xml_template_value xml_token xml_value";
