...
/* Tests the libfwevt_provider_get_channel function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_channel(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error    = NULL;
	...
	{
		result = libfwevt_provider_get_channel(
		          provider,
		          0,
		          &channel,
		          &error );
...
/* Tests the libfwevt_provider_get_event function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_event(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error = NULL;
	...
	{
		result = libfwevt_provider_get_event(
		          provider,
		          0,
		          &event,
		          &error );
...
/* Tests the libfwevt_provider_get_keyword function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_keyword(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error    = NULL;
	...
	{
		result = libfwevt_provider_get_keyword(
		          provider,
		          0,
		          &keyword,
		          &error );
...
/* Tests the libfwevt_provider_get_level function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_level(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error = NULL;
	...
	{
		result = libfwevt_provider_get_level(
		          provider,
		          0,
		          &level,
		          &error );
...
/* Tests the libfwevt_provider_get_map function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_map(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error = NULL;
	...
	if( number_of_maps > 0 )
	{
		result = libfwevt_provider_get_map(
		          provider,
		          0,
		          &map,
		          &error );
...
/* Tests the libfwevt_provider_get_opcode function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_opcode(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error  = NULL;
	...
	{
		result = libfwevt_provider_get_opcode(
		          provider,
		          0,
		          &opcode,
		          &error );
...
/* Tests the libfwevt_provider_get_task function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_task(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error = NULL;
	...
	{
		result = libfwevt_provider_get_task(
		          provider,
		          0,
		          &task,
		          &error );
...
/* Tests the libfwevt_provider_get_template function
 * Returns 1 if successful or 0 if not
 */
int fwevt_test_provider_get_template(
     libfwevt_provider_t *provider )
{
	libcerror_error_t *error      = NULL;
	...
	{
		result = libfwevt_provider_get_template(
		          provider,
		          0,
		          &template,
		          &error );
...
#endif
{
	...
	FWEVT_TEST_RUN_WITH_ARGS(
	 ...
	 fwevt_test_provider_get_channel,
	 provider );
	...
	FWEVT_TEST_RUN_WITH_ARGS(
	 ...
	 fwevt_test_provider_get_keyword,
	 provider );
	...
	FWEVT_TEST_RUN_WITH_ARGS(
	 ...
	 fwevt_test_provider_get_opcode,
	 provider );
	...
	FWEVT_TEST_RUN_WITH_ARGS(
	 ...
	 fwevt_test_provider_get_template,
	 provider );
