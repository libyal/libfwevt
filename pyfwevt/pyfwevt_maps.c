...
PySequenceMethods pyfwevt_maps_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwevt_maps_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwevt_maps_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwevt_maps_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwevt.maps",
	/* tp_basicsize */
	sizeof( pyfwevt_maps_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwevt_maps_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	/* tp_doc */
	"pyfwevt sequence and iterator object of maps",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwevt_maps_iter,
	/* tp_iternext */
	(iternextfunc) pyfwevt_maps_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
...
/* Creates a new maps sequence and iterator object
...
PyObject *pyfwevt_maps_new(
           ...
           int number_of_items )
{
	pyfwevt_maps_t *sequence_object = NULL;
	static char *function           = "pyfwevt_maps_new";
	...
	/* Make sure the maps values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwevt_maps,
	                   &pyfwevt_maps_type_object );
...
/* Initializes an maps sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyfwevt_maps_init(
     pyfwevt_maps_t *sequence_object )
{
	static char *function = "pyfwevt_maps_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of maps not supported.",
	 function );

	return( 0 );
}

/* Frees an maps sequence object
 */
void pyfwevt_maps_free(
      pyfwevt_maps_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwevt_maps_free";
...
/* The maps len() function
 */
Py_ssize_t pyfwevt_maps_len(
            pyfwevt_maps_t *sequence_object )
{
	static char *function = "pyfwevt_maps_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function = "pyfwevt_maps_getitem";
	...
	map_object = sequence_object->get_item_by_index(
...
/* The maps iter() function
 */
PyObject *pyfwevt_maps_iter(
           pyfwevt_maps_t *sequence_object )
{
	static char *function = "pyfwevt_maps_iter";
...
/* The maps iternext() function
 */
PyObject *pyfwevt_maps_iternext(
           pyfwevt_maps_t *sequence_object )
{
	PyObject *map_object  = NULL;
	static char *function = "pyfwevt_maps_iternext";
