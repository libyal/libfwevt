...
PySequenceMethods pyfwevt_opcodes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwevt_opcodes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwevt_opcodes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwevt_opcodes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwevt.opcodes",
	/* tp_basicsize */
	sizeof( pyfwevt_opcodes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwevt_opcodes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfwevt_opcodes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfwevt sequence and iterator object of opcodes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwevt_opcodes_iter,
	/* tp_iternext */
	(iternextfunc) pyfwevt_opcodes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
...
/* Creates a new opcodes sequence and iterator object
...
PyObject *pyfwevt_opcodes_new(
           ...
           int number_of_items )
{
	pyfwevt_opcodes_t *sequence_object = NULL;
	static char *function              = "pyfwevt_opcodes_new";
	...
	/* Make sure the opcodes values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwevt_opcodes,
	                   &pyfwevt_opcodes_type_object );
...
/* Initializes an opcodes sequence and iterator object
...
{
	static char *function = "pyfwevt_opcodes_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of opcodes not supported.",
	 function );

	return( -1 );
}

/* Frees an opcodes sequence object
 */
void pyfwevt_opcodes_free(
      pyfwevt_opcodes_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwevt_opcodes_free";
...
/* The opcodes len() function
 */
Py_ssize_t pyfwevt_opcodes_len(
            pyfwevt_opcodes_t *sequence_object )
{
	static char *function = "pyfwevt_opcodes_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function   = "pyfwevt_opcodes_getitem";
	...
	opcode_object = sequence_object->get_item_by_index(
...
/* The opcodes iter() function
 */
PyObject *pyfwevt_opcodes_iter(
           pyfwevt_opcodes_t *sequence_object )
{
	static char *function = "pyfwevt_opcodes_iter";
...
/* The opcodes iternext() function
 */
PyObject *pyfwevt_opcodes_iternext(
           pyfwevt_opcodes_t *sequence_object )
{
	PyObject *opcode_object = NULL;
	static char *function   = "pyfwevt_opcodes_iternext";
