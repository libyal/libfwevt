...
PySequenceMethods pyfwevt_levels_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwevt_levels_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwevt_levels_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwevt_levels_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwevt.levels",
	/* tp_basicsize */
	sizeof( pyfwevt_levels_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwevt_levels_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfwevt_levels_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfwevt sequence and iterator object of levels",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwevt_levels_iter,
	/* tp_iternext */
	(iternextfunc) pyfwevt_levels_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
...
/* Creates a new levels sequence and iterator object
...
PyObject *pyfwevt_levels_new(
           ...
           int number_of_items )
{
	pyfwevt_levels_t *sequence_object = NULL;
	static char *function             = "pyfwevt_levels_new";
	...
	/* Make sure the levels values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwevt_levels,
	                   &pyfwevt_levels_type_object );
...
{
	static char *function = "pyfwevt_levels_init";
      ...
      pyfwevt_levels_t *sequence_object )
{
	...
	static char *function       = "pyfwevt_levels_free";
...
/* The levels len() function
 */
Py_ssize_t pyfwevt_levels_len(
            pyfwevt_levels_t *sequence_object )
{
	static char *function = "pyfwevt_levels_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function  = "pyfwevt_levels_getitem";
	...
	level_object = sequence_object->get_item_by_index(
...
/* The levels iter() function
 */
PyObject *pyfwevt_levels_iter(
           pyfwevt_levels_t *sequence_object )
{
	static char *function = "pyfwevt_levels_iter";
...
/* The levels iternext() function
 */
PyObject *pyfwevt_levels_iternext(
           pyfwevt_levels_t *sequence_object )
{
	PyObject *level_object = NULL;
	static char *function  = "pyfwevt_levels_iternext";
