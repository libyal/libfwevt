...
PySequenceMethods pyfwevt_keywords_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwevt_keywords_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwevt_keywords_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwevt_keywords_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwevt.keywords",
	/* tp_basicsize */
	sizeof( pyfwevt_keywords_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwevt_keywords_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfwevt_keywords_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfwevt sequence and iterator object of keywords",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwevt_keywords_iter,
	/* tp_iternext */
	(iternextfunc) pyfwevt_keywords_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfwevt_keywords_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new keywords sequence and iterator object
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfwevt_keywords_new(
           ...
           int number_of_items )
{
	pyfwevt_keywords_t *sequence_object = NULL;
	static char *function               = "pyfwevt_keywords_new";
	...
	/* Make sure the keywords values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwevt_keywords,
	                   &pyfwevt_keywords_type_object );
...
/* Initializes an keywords sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyfwevt_keywords_init(
     pyfwevt_keywords_t *sequence_object )
{
	static char *function = "pyfwevt_keywords_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of keywords not supported.",
	 function );

	return( 0 );
}

/* Frees an keywords sequence object
 */
void pyfwevt_keywords_free(
      pyfwevt_keywords_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwevt_keywords_free";
...
/* The keywords len() function
 */
Py_ssize_t pyfwevt_keywords_len(
            pyfwevt_keywords_t *sequence_object )
{
	static char *function = "pyfwevt_keywords_len";
...
/* The keywords getitem() function
 */
PyObject *pyfwevt_keywords_getitem(
           pyfwevt_keywords_t *sequence_object,
           Py_ssize_t item_index )
{
	PyObject *keyword_object = NULL;
	static char *function    = "pyfwevt_keywords_getitem";
	...
	keyword_object = sequence_object->get_item_by_index(
...
/* The keywords iter() function
 */
PyObject *pyfwevt_keywords_iter(
           pyfwevt_keywords_t *sequence_object )
{
	static char *function = "pyfwevt_keywords_iter";
...
/* The keywords iternext() function
 */
PyObject *pyfwevt_keywords_iternext(
           pyfwevt_keywords_t *sequence_object )
{
	PyObject *keyword_object = NULL;
	static char *function    = "pyfwevt_keywords_iternext";
