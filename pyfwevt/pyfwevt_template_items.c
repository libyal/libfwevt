/*
 * Python object definition of the sequence and iterator object of template_items
 *
...
PySequenceMethods pyfwevt_template_items_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwevt_template_items_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwevt_template_items_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwevt_template_items_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwevt.template_items",
	/* tp_basicsize */
	sizeof( pyfwevt_template_items_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwevt_template_items_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfwevt_template_items_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfwevt sequence and iterator object of template items",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwevt_template_items_iter,
	/* tp_iternext */
	(iternextfunc) pyfwevt_template_items_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfwevt_template_items_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new template_items sequence and iterator object
...
PyObject *pyfwevt_template_items_new(
           ...
           int number_of_items )
{
	pyfwevt_template_items_t *sequence_object = NULL;
	static char *function               = "pyfwevt_template_items_new";
	...
	/* Make sure the template_items values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwevt_template_items,
	                   &pyfwevt_template_items_type_object );
...
/* Initializes a template_items sequence and iterator object
...
{
	static char *function = "pyfwevt_template_items_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of template_items not supported.",
	 function );

	return( -1 );
}

/* Frees a template_items sequence object
 */
void pyfwevt_template_items_free(
      pyfwevt_template_items_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwevt_template_items_free";
...
/* The template_items len() function
 */
Py_ssize_t pyfwevt_template_items_len(
            pyfwevt_template_items_t *sequence_object )
{
	static char *function = "pyfwevt_template_items_len";
...
/* The template_items getitem() function
 */
PyObject *pyfwevt_template_items_getitem(
           pyfwevt_template_items_t *sequence_object,
           Py_ssize_t item_index )
{
	PyObject *template_item_object = NULL;
	static char *function    = "pyfwevt_template_items_getitem";
	...
	template_item_object = sequence_object->get_item_by_index(
...
/* The template_items iter() function
 */
PyObject *pyfwevt_template_items_iter(
           pyfwevt_template_items_t *sequence_object )
{
	static char *function = "pyfwevt_template_items_iter";
...
/* The template_items iternext() function
 */
PyObject *pyfwevt_template_items_iternext(
           pyfwevt_template_items_t *sequence_object )
{
	PyObject *template_item_object = NULL;
	static char *function    = "pyfwevt_template_items_iternext";
