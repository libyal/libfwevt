...
#include "pyfwevt_integer.h"
#include "pyfwevt_python.h"

/* Creates a new signed integer object from a 64-bit value
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfwevt_integer_signed_new_from_64bit(
           int64_t value_64bit )
{
	PyObject *integer_object = NULL;
	static char *function    = "pyfwevt_integer_signed_new_from_64bit";
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfwevt_integer_unsigned_new_from_64bit(
           uint64_t value_64bit )
{
	PyObject *integer_object = NULL;
	static char *function    = "pyfwevt_integer_unsigned_new_from_64bit";
 ...
 */
int pyfwevt_integer_signed_copy_to_64bit(
     PyObject *integer_object,
     int64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function   = "pyfwevt_integer_signed_copy_to_64bit";
	int result              = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int pyfwevt_integer_unsigned_copy_to_64bit(
     PyObject *integer_object,
     uint64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function   = "pyfwevt_integer_unsigned_copy_to_64bit";
	int result              = 0;
