...
{
	static char *function = "libfwevt_notify_set_stream";
...
int libfwevt_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfwevt_notify_stream_open";
...
int libfwevt_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfwevt_notify_stream_close";
